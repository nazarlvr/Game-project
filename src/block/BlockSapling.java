...
public class BlockSapling extends Block
{
    ...
    public void tick(World world, int x, int y) {
        ...
        if (this.blockData == 0)
        {
            ...
            world.setBlock(x, y + 3, Blocks.oak_leaves);
            world.setBlock(x, y + 4, Blocks.oak_leaves);
            world.setBlock(x, y + 5, Blocks.oak_leaves);
            world.setBlock(x + 1, y + 3, Blocks.oak_leaves);
            world.setBlock(x - 2, y + 3, Blocks.oak_leaves);
            world.setBlock(x + 2, y + 3, Blocks.oak_leaves);
            world.setBlock(x + 1, y + 4, Blocks.oak_leaves);
            world.setBlock(x - 1, y + 3, Blocks.oak_leaves);
            world.setBlock(x - 1, y + 4, Blocks.oak_leaves);
            world.setBlock(x + 1, y + 2, Blocks.oak_leaves);
            world.setBlock(x - 1, y + 2, Blocks.oak_leaves);
        }
